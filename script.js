(function () {
  ...
  formLogin.addEventListener('submit', function (e) {
    ...
    var stored = JSON.parse(localStorage.getItem(STORAGE_USER) || 'null');
    if (!stored) {
    ...
    localStorage.setItem(STORAGE_USER, JSON.stringify(stored));
    updateAuthUI();
    closeAuthModal();
    formLogin.reset();
  ...
  formRegister.addEventListener('submit', function (e) {
    ...
    var existing = JSON.parse(localStorage.getItem(STORAGE_USER) || 'null');
    ...
    localStorage.setItem(STORAGE_USER, JSON.stringify(toStore));
